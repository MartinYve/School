            ...
            <div class="container-fluid">
                ...
                <div class="iq-card">
                    <div class="iq-card-body">
                        <form class="form" method="POST" action="{{route('devoirs.update', $information['0']['id'])}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                            <div class="col-lg-12">
                                ...
                                <div class="iq-card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input value="{{$information['0']['heure']}}" placeholder="Exemple : 7H00 - 10H00" type="text" class="form-control form-control-solid" name="heure" id="heure" required />
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control select2"  name="enseignant" id="selectuserrole" required>
                                                @foreach($enseignants as $enseignant)
                                                    <option value="{{ $enseignant->name }}"  @if( $information['0']['enseignant'] == $enseignant->name) selected @endif >{{ $enseignant->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control select2"  name="enseignement" id="selectuserrole" required>
                                                @foreach($enseignements as $enseignement)
                                                    <option value="{{ $enseignement->name }}" @if( $information['0']['enseignement'] == $enseignement->name) selected @endif>{{ $enseignement->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger enseignement" ></strong></span>
                                            ...
                                            <div class="form-group col-md-12">
                                                <textarea   rows="5" cols="100" placeholder="Entrez le contenu du cours"  class="form-control form-control-solid" name="contenu" id="contenu">{{ $information['0']['contenu'] }}</textarea>
                                            </div>
