    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/etudiant">Etudiant</a></li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue"> Ajouter Etudiant</h4>
        </div>
        <br>
        <br>
    </div>
    <form method="post" action="{{ route('etudiant.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">
                <i class="icon-copy fa fa-group" aria-hidden="true"></i>&nbsp;Classe</label>
            <div class="col-sm-12 col-md-10">
                <select class="custom-select col-12 @error('classe') is-invalid @enderror" name="classe" placeholder="Sélectionnez une classe">
                    @if(count($classes) > 0)
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control @error('nom') is-invalid @enderror" placeholder="Entrer votre nom de famille"
                    type="nom" name="nom" value="{{ old('nom') }}">
            </div>
            @error('nom')
            <div class="form-control-feedback col-sm-12 col-md-10 has-danger" style="padding-left: 18%">{{ $message }}
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control @error('prenom') is-invalid @enderror" placeholder="Entrer votre prénom"
                    type="nom" name="prenom" value="{{ old('prenom') }}">
            </div>
            @error('prenom')
            <div class="form-control-feedback col-sm-12 col-md-10 has-danger" style="padding-left: 18%">{{ $message }}
            </div>
