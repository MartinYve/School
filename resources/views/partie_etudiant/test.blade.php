...
<form action="/resultat_etudiant/1/2" method="GET">
    @csrf
    @method('GET')
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
...
<table>
    ...
    <tr>
        ...
        <td>
            <div class="custom-control custom-checkbox">
                <input value="{{ $question->choix1 }}" type="checkbox" class="custom-control-input" id="reponse1_{{$question->id}}"
    ...
    <tr>
        ...
        <td>
            <div class="custom-control custom-checkbox">
                <input  value="{{ $question->choix2 }}" type="checkbox" class="custom-control-input" id="reponse2_{{$question->id}}"
        ...
        <td>
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="reponse3_{{$question->id}}"
                   value="{{ $question->choix3 }}" name="reponse3_{{$question->id}}">
        ...
        <td>
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="reponse4_{{$question->id}}"
                  value="{{ $question->choix4 }}"  name="reponse4_{{$question->id}}">
